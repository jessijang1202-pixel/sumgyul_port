...
const content = {
  kr: {
    ...
    portfolio: [
      ...
      { industry: "Community App", title: "평택광장", description: "지역 정당 당원을 위한 정보공유 앱. 현수막 지도, 행사 일정, 자원봉사 지도, 인사/업체 소개 등 정보를 공유하고 리포팅.", image: "/p_pyungtaek.jpg" },
      { industry: "Productivity App", title: "솔로플로우 (SoloFlow)", description: "개인의 월간·주간·일간 목표를 설정하고 실행과 달성율을 관리하는 목표 관리 앱. 프로젝트별 카테고리별 관리가 가능해서 다수의 프로젝트를 동시에 운영하는 사람에게 적합.", image: "/p_soloflow.jpg" },
  ...
  en: {
    ...
    portfolio: [
      ...
      { industry: "Community App", title: "Pyeongtaek Plaza", description: "An information-sharing app for members of a local political party — sharing and reporting on banner maps, event schedules, volunteer maps, and greetings/business introductions.", image: "/p_pyungtaek.jpg" },
      { industry: "Productivity App", title: "SoloFlow", description: "A goal-management app for setting monthly, weekly, and daily goals and tracking execution and completion rates. Supports project- and category-based organization, making it well suited for anyone running multiple projects at once.", image: "/p_soloflow.jpg" },
